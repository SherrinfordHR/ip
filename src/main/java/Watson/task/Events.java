...
public class Events extends Task {
    ...
    public String toString() {
        String fromtoString = (fromdate != null) ?
                fromdate.format(DateTimeFormatter.ofPattern("MMM dd yyyy, h:mm a")) :
                this.from;
        String totoString = (todate != null) ?
                todate.format(DateTimeFormatter.ofPattern("MMM dd yyyy, h:mm a")) :
                this.to;
